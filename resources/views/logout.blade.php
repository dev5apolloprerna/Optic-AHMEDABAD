        ...
        <div class="auth-page-content">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5" style="margin-top: 155px">
                        <div class="card mt-4">
                            <div class="card-body p-4 text-center">
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <p class="text-muted">Thank you for Visiting
                                        <span class="fw-bold">{{ env('APP_NAME') }}</span>
                                    </p>
                                    <div class="mt-4">
                                        <a style="background: #1b4e9b !important;" href="{{ route('login') }}"
                                            class="btn btn-success w-100">Sign In</a>
                                    </div>
                                </div>
                            </div>
                            <!-- end card body -->
