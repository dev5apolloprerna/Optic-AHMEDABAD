        ...
        <div class="page-content">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">International Visitor List</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" id="form" action="{{ route('visitor.international_index') }}">
                                @csrf
                                <div class="row  align-items-center">
                                    <div class="col-md-3  mb-2">
                                        <div class="d-flex align-items-center">
                                            <select class="form-control" name="strEntryDate">
                                                ...
                                                <option value="3rd October 2026"
                                                    {{ $EntryDate == '3rd October 2026' ? 'selected' : '' }}>
                                                    3rd October 2026</option>
                                                <option value="4th October 2026"
                                                    {{ $EntryDate == '4th October 2026' ? 'selected' : '' }}>
                                                    4th October 2026</option>
                                                <option value="5th October 2026"
                                                    {{ $EntryDate == '5th October 2026' ? 'selected' : '' }}>
                                                    5th October 2026</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3  mb-2">
                                    ...
                                    <div class="col-md-3  mb-2">
                                        <div class="input-group d-flex justify-content-right">
                                            ...
                                            <a class="btn btn-primary" href="{{ route('visitor.international_index') }}">
                                                Cancel
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group" style="justify-content: right;">
                                            <a href="{{ route('visitor.internationalexcel', [$Mobile ?? 0, $EntryDate ?? 0]) }}">
